...
export default async function About({}: AboutProps) {
  ...
  return (
    <div className="mx-auto mt-6 max-w-3xl">
      ...
      <p>
        My name is Bartosz Wiśniewski and I am software developer, with a
        passion for learning and building stuff. Programming polyglot with a
        special place in heart for Flutter, React, Rust <Crab /> and TypeScript.
      </p>
      <div className="mt-2 rounded-md bg-gray-50 p-4">
        ...
        <p className="font-mono">
          ...
          <a className="hover:underline" href="mailto:blog@12345.pl">
            bartek@pr0gramista.com
          </a>
        </p>
      </div>
      <AboutMdx />
      <Polish />
      <h3 className="mt-2 font-mono text-2xl font-semibold">Latest posts</h3>
      <div className="mx-auto mt-2 max-w-3xl space-y-4">
        {articles.map((article) => {
          return (
            <article key={article.href} className="max-w-xl">
              <Link href={article.href}>
                <span className="mb-1 font-mono text-lg font-semibold hover:underline">
                  {article.title}
                </span>
              </Link>
